...
const FarmerApplicantsPage = () => {
  ...
  const updateStatusMutation = api.organicFarmersData.updateStatus.useMutation({
    onSuccess: () => {
        ...
        <div className="mb-6 sm:mb-8">
          <div className="flex flex-col space-y-4 sm:flex-row sm:items-center sm:justify-between sm:space-y-0">
            <div>
              ...
              archived farmers registrations
              </p>
            </div>
                                  ...
                                  <DropdownMenu>
                                    ...
                                    >
                                      ...
                                      <DropdownMenuItem
                                        ...
                                        className="cursor-pointer text-orange-600 hover:text-green-700"
                                      >
                                        <UserCheck className="mr-2 h-4 w-4" />
                                        Reinstate
                                      </DropdownMenuItem>

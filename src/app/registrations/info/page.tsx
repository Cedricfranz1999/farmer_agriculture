    ...
    <>
      ...
      {showActions && (
        <div className="no-print fixed top-4 right-4 z-50 flex space-x-4">
          ...
          <button
            onClick={handleLogin}
            className="flex transform items-center space-x-2 rounded-lg bg-green-600 px-6 py-3 font-semibold text-white shadow-lg transition-all duration-200 hover:scale-105 hover:bg-green-700 hover:shadow-xl focus:ring-4 focus:ring-green-300 focus:outline-none"
          >
            <svg
              className="h-5 w-5"
              fill="none"
              ...
              <div className="avoid-break">
                ...
                <div className="flex flex-wrap justify-center gap-4 md:justify-start">
                  ...
                  <div className="text-center">
                    ...
                    <div className="relative h-20 w-32 overflow-hidden rounded-lg border-2 border-gray-300 shadow-sm">
                      <Image
                        src={farmer.farmerImage || "/placeholder.svg"}
                        alt="Farmer"
                        fill
                        className="object-cover"
                        sizes="128px"
